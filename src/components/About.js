    ...
    render () {
        return (
            <Row className='text-white d-flex align-items-end w-100' id='about'>
                ...
                <Col xl={{span: 10, offset: 1}} lg={{span: 10, offset: 1}} md={{span: 10, offset: 1}} sm={{span: 10, offset: 1}} xs={{span: 11, offset: 1}} className='primary font-weight-bold about-container'>
                    <p className='about-title'>About Me</p>
               
                    <p className='about-description text-justify'>
                        Hi, my name is Deon Choi. I recently graduated from <a href='https://www.gwu.edu/' target='_blank' rel="noopener noreferrer">The George Washington University</a> in May 2019 with a Bachelor of Science in Statistics along with a Minor in Computer Science. 
                        ...
                        Eventually I made my way over to <span>Sass</span>, <span>Bootstrap</span>, <span>React</span>, and <span>Redux</span>.
                        I love picking up new skills as well as creative problem solving.
                        <br></br>
